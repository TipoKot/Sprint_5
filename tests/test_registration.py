...
class TestUserRegistration:
    ...
    def test_user_can_register(self, driver, email):
        driver.get(BASE_URL)
    ...
    def test_user_cant_register_with_wrong_email(self, driver, wrong_email):
        driver.get(BASE_URL)
    ...
    def test_user_cant_register_with_the_same_credentials(self, driver, existing_email):
        driver.get(BASE_URL)
